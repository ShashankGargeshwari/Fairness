...
class gamemanager(object):
    ...
    def __init__(self, window, xSize, ySize, ppu):
        ...
        pn = 0
        fn = 0
        # Iterate through the matrix of cells and insert food or player into them
    ...
    def display(self):
        ...
        # Compute the next move for all players in the game
        ...
        # Move all the players based on their computed next move
        for p in self.players:
